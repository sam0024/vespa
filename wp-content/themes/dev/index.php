    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up"><?php echo $dev['b_title']; ?></h1>
          <h2 data-aos="fade-up" data-aos-delay="400"><?php echo $dev['b_sub_title']; ?></h2>
          <div data-aos="fade-up" data-aos-delay="800">
            <a href="<?php echo $dev['b_btn']; ?>" class="btn-get-started scrollto">Get Started</a>
          </div>
        </div>
        <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
          <img src="<?php echo $dev['b_img']['url']; ?>" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2><?php echo $dev['s_title']; ?></h2>
          <p><?php echo $dev['s_desc']; ?></p>
        </div>
        <div class="row">
          <?php 
          $args = array( 
          ...
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
            <div class="icon-box" data-aos="fade-up" data-aos-delay="100">
              <div class="icon"><i class="<?php echo get_field('s_icon'); ?>"></i></div>
              <h4 class="title"><a href=""><?php the_title(); ?></a></h4>
              <p class="description"><?php echo get_field('s_desc'); ?></p>
            </div>
          </div>
          <?php endwhile; ?>
        </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch">
            <div class="card" data-aos="fade-up" data-aos-delay="100">
              <div class="card-body">
                ...
                <p class="card-text"><?php echo get_field('ms_desc'); ?></p>
                <div class="read-more"><a href="<?php echo get_field('ms_link'); ?>"><i class="icofont-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
          <?php endwhile; ?>
      ...
      <div class="container">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="300">
          <div class="col-lg-3 col-md-4">
            <div class="icon-box">
              <i class="ri-store-line" style="color: #47aeff;"></i>
          ...
          <div class="col-lg-3 col-md-4 mt-4 mt-lg-0">
            <div class="icon-box">
              <i class="ri-paint-brush-line" style="color: #47aeff;"></i>
          ...
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-anchor-line" style="color: #47aeff;"></i>
          ...
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              <i class="ri-base-station-line" style="color: #47aeff;"></i>
    ...
    <section id="team" class="team section-bg">
      <div class="container">
        ...
        <div class="section-title" data-aos="fade-up">
          <h2><?php echo $dev['t_title']; ?></h2>
          <p><?php echo $dev['t_desc']; ?></p>
        </div>
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
            <div class="member" data-aos="fade-up" data-aos-delay="100">
              <div class="member-img">
                <img src="<?php echo get_field('tm_img')['url']; ?>" class="img-fluid" alt="">
                <div class="social">
                  <a href="<?php echo get_field('tm_tw'); ?>"><i class="icofont-twitter"></i></a>
                  <a href="<?php echo get_field('tm_fb'); ?>"><i class="icofont-facebook"></i></a>
                  <a href="<?php echo get_field('tm_ig'); ?>"><i class="icofont-instagram"></i></a>
                  <a href="<?php echo get_field('tm_li'); ?>"><i class="icofont-linkedin"></i></a>
                </div>
              </div>
              <div class="member-info">
                <h4><?php the_title(); ?></h4>
                <span><?php echo get_field('tm_desig'); ?></span>
              </div>
            </div>
          </div>
          <?php endwhile; ?>      
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="contact-about">
              <h3><?php echo $dev['c_brand']; ?></h3>
              <p><?php echo $dev['c_b_desc']; ?></p>
              <div class="social-links">
                <a href="<?php echo $dev['c_tw']; ?>" class="twitter"><i class="icofont-twitter"></i></a>
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-md-0" data-aos="fade-up" data-aos-delay="200">
            <div class="info">
              <div>
                ...
                <p><?php echo $dev['c_location']; ?></p>
              </div>

              <div>
                <i class="ri-mail-send-line"></i>
                <p><?php echo $dev['c_email']; ?></p>
              </div>

              <div>
                <i class="ri-phone-line"></i>
                <p><?php echo $dev['c_phone']; ?></p>
              </div>
          ...
          <div class="col-lg-5 col-md-12" data-aos="fade-up" data-aos-delay="300">
            ...
            <!--contact form-->
            <?php echo do_shortcode($dev['c_form']); ?>
